...
object CyberTodoMapper {
    ...
    private const val CYBER_LMS_URL = "https://lms.kcu.ac/atnlcSubj/atnlcApe/list"
    ...
    /**
     * 일반 Canvas LMS 과목(양수 ID)과 충돌을 방지하기 위해 음수 고유 ID를 생성합니다.
     */
    ...
    /**
     * "30:00" 같은 시간 문자열을 초 단위(Double)로 변환합니다.
     */
